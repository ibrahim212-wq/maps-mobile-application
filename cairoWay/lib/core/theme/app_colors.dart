...
class AppColors {
  ...
  static const Color primaryGreen = Color(0xFF00A854);
  static const Color darkGlassFillStrong = Color(0xCC0A1F14);
  static const Color lightGlassFillStrong = Color(0xCCF5F5F5);
  static const Color darkGlassStroke = Color(0x3300A854);
  static const Color lightGlassStrokeSecondary = Color(0xFF00A854);
